...
/**
 * Servlet implementation class ZKUpdate
 */
@WebServlet("/ZKUpdate")
public class ZKUpdate extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            out.print("<h1 align=\"center\">" + title + " " + tableName + "</h1>\n");
            Util.ConnectSQL();
            ...
            out.println("<form action=\"ZKUpdateResult\"\n" +
                    " method=\"get\">" +
                    "<input type=\"radio\" checked=\"checked\" name=\"tableName\" value=\"" + tableName + "\" /><br>");
            out.print("<h3>Which row you want to update?</h3><br>" +
                    "<p><select name = \"key1\">");
            ...
            out.print("<h3>What values you want to change to?</h3><br>");
